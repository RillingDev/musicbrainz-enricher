...
const MusicbrainzService_1 = require("../util/MusicbrainzService");
    ...
    enrichLegalNameFromDiscogs(mbArtist, discogsArtist) {
        ...
        if (discogsLegalName != null) {
            if (discogsLegalName === mbArtist.name) {
                ArtistEnrichmentService_1.logger.info(`Legal name ${discogsLegalName} is already used as main name '${mbArtist.name}'.`);
            }
