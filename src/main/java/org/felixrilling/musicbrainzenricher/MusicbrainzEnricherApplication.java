...
public class MusicbrainzEnricherApplication implements CommandLineRunner {
    ...
    public MusicbrainzEnricherApplication(ReleaseEnricherService releaseEnricherService, MusicbrainzService musicbrainzService) {
    ...
    public void run(String... args) throws Exception {
        ...
        includes.includeAll();
        ArtistWs2 artistWs2 = musicbrainzService.lookUpArtist("947eaa1e-92e7-4dc3-9529-5cc6d3396e5d", includes);
